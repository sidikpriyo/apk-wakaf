                 ...
                 ">
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <button
                                class="ml-4 focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 focus:bg-blue-800 focus:outline-none w-full sm:w-auto bg-blue-700 transition duration-150 ease-in-out hover:bg-blue-600 rounded text-white px-8 py-3 text-sm"
                                type="submit">
                                {{ __('Ubah Kata Sandi') }}
                            </button>
                        </div>
                ...
                <div class="
                 ...
                 ">
                    ...
                    <p class="text-xl text-white leading-normal pt-3 xl:w-10/12">
                        Silahkan masukan kata sandi baru yang ingin anda gunakan.
                    </p>
                </div>
