...
@section('sidebar-body')
    <ul>
        <li class="mb-2 block text-sm text-gray-700 py-1.5 px-2 mx-4 hover:bg-gray-100 rounded bg-gray-100">
            <a href="{{ route('donatur-profil.index') }}" aria-current="page">Beranda</a>
        </li>
    </ul>
@endsection
...
@section('body')
    <div class="bg-white rounded-lg border border-gray-200">
        <h2 class="font-semibold text-xl p-6">Profil Donatur</h2>
        ...
        <div class="flex items-center justify-between p-6">
            <a href="{{ route('donatur-profil.edit', ['profil' => $profil->id]) }}"
