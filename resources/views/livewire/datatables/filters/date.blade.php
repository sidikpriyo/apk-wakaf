<div x-data class="flex flex-col">
    <div class="w-full relative flex">
        <input x-ref="start" class="m-1 pr-6 text-sm pt-1 flex-grow form-input rounded border-gray-300 border" type="date"
    ...
    <div class="w-full relative flex">
        <input x-ref="end" class="m-1 pr-6 text-sm pt-1 flex-grow form-input rounded border-gray-300 border" type="date"
