...
@section('body')
    <div class="bg-white rounded-lg shadow-lg">
        <h2 class="font-semibold text-xl p-6">Detail Kategori</h2>
        ...
        <div class="flex items-center space-x-1 justify-start p-6">
            ...
            <form method="POST" action="{{ route('kategori.destroy', ['kategori' => $kategori->id]) }}">
                @method('DELETE')
                @csrf

                <a :href="{{ route('kategori.destroy', ['kategori' => $kategori->id]) }}"
