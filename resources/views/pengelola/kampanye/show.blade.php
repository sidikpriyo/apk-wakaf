...
@section('body')
    <div class="bg-white rounded-lg border border-gray-200">
        ...
        <div class="flex items-center space-x-1 justify-start p-6">
            <a href="{{ route('kampanye.edit', ['kampanye' => $kampanye->id]) }}"
            ...
            <form method="POST" action="{{ route('kampanye.destroy', ['kampanye' => $kampanye->id]) }}">
                @method('DELETE')
                @csrf

                <a :href="{{ route('kampanye.destroy', ['kampanye' => $kampanye->id]) }}"
