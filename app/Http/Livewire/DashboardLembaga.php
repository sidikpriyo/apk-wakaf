...
class DashboardLembaga extends Component
{
    public function render()
    {
        $donasi = Donasi::selectRaw('DATE(created_at) as tanggal, SUM(nominal) as nominal, COUNT(*) as total')->whereHas('kampanye', function ($query) {
            $query->where('lembaga_id', auth()->id());
        })->lunas()->groupBy('tanggal')->get()->toArray();
        ...
        return view('livewire.dashboard-lembaga')->with([
